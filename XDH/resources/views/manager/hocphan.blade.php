...
@section('content')
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-3">
                    <a href="{{ route('manager.hocphan') }}" style=" color: black;">
                ...
                <div class="col-sm-9">
                    <div class="row mb-2 ">
                        ...
                        <div class="col-sm-6">
                            <div class="row mb-2 ">
                                <div class="col-sm-9">
                                    <a href="{{ route('manager.hocphan.xuat') }}" class="float-left btn btn-light"><i
                                ...
                                <tbody>
                                    @foreach ($hocphan as $value)
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{ route('manager.hocphan.chitiet', ['id' => $value->id]) }}"
