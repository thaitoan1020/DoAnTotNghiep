...
@section('content')
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-3">
            <a href="{{ route('supmanager.ctdt') }}" style=" color: black;">
          ...
          <div class="col-md-12">
            <div class="card">
              ...
              <div class="card-body table-responsive p-0" style="height: 100%;">
                <table id="TableTimKiem" class="table table-bordered-fixed text-nowrap" style="width: 100%;">
                  <thead>
                    <tr>
                      <th style="width: 2%">#</th>
    ...
    <form action="{{ route('supmanager.ctdt.them') }}" method="post">
    @csrf
  ...
  <form action="{{ route('supmanager.ctdt.sua') }}" method="post">
    @csrf
  ...
  <form action="{{ route('supmanager.ctdt.xoa') }}" method="post">
    @csrf
