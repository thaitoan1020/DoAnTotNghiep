            ...
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                        ...
                        <a href="{{ route('user.doimatkhau') }}" class="dropdown-item">
                    ...
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                        ...
                        <li class="nav-item menu-open">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="{{ route('user.hocphan') }}" class="nav-link">
                        ...
                        <li class="nav-item menu-open">
                            <a href="{{ route('user.ctdt_hocphan_hocky') }}" class="nav-link"
                        ...
                        <li class="nav-item menu-open">
                            <a href="{{ route('user.ctdt_hocphan_khoikienthuc') }}" class="nav-link"
                        ...
                        <li class="nav-item menu-open">
                            <a href="{{ route('user.hocphanxem') }}" class="nav-link"
                                title="Chương trình đào tạo theo học kỳ">
                                <i class="nav-icon fas fa-desktop"></i>
                                <p>
                                    Danh sách học phần
