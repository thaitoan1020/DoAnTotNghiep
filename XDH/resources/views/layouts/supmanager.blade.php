...
<div class="wrapper">
      ...
      <li class="nav-item dropdown">
        <a class="nav-link" data-toggle="dropdown" href="#" style="padding-top: 3px;">
          ...
          <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
            ...
            <a href="{{ route('supmanager.doimatkhau')}}" class="dropdown-item" >
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    <!-- Brand Logo -->
    <a href="{{ route('supmanager.home') }}" class="brand-link">
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          <!-- Add icons to the links using the .nav-icon class
               ...
               <li class="nav-item menu-open">
                ...
                <ul class="nav nav-treeview">
                  <li class="nav-item">
                    <a href="{{ route('supmanager.ctdt') }}" class="nav-link" title="Danh sách chương trình đào tạo">
                      <i class="far fa-circle nav-icon"></i>
                      <p>Danh sách CTĐT</p>
                    </a>
                  </li> 
                  <li class="nav-item">
                    <a href="{{ route('supmanager.hocphan') }}" class="nav-link">
                      <i class="far fa-circle nav-icon"></i>
                      <p>Danh sách học phần</p>
                    </a>
                  </li>
                  <li class="nav-item">
                    <a href="{{ route('supmanager.giangvien') }}" class="nav-link">
                      <i class="far fa-circle nav-icon"></i>
                      <p>Danh sách giảng viên</p>
                    </a>
                  </li><li class="nav-item">
                    <a href="{{ route('supmanager.nhomgiangvien') }}" class="nav-link">
                      <i class="far fa-circle nav-icon"></i>
          ...
          <li class="nav-item menu-open">
            <a href="{{ route('supmanager.ctdt_hocphan',['id'=>-1]) }}" class="nav-link">
          ...
          <li class="nav-item menu-open">
            <a href="{{ route('supmanager.ctdt_hocphan_hocky') }}" class="nav-link" title="Chương trình đào tạo theo học kỳ">
              <i class="nav-icon fas fa-desktop"></i>
              <p>
                CTĐT theo học kỳ
              </p>
          ...
          <li class="nav-item menu-open">
            <a href="{{ route('supmanager.ctdt_hocphan_khoikienthuc') }}" class="nav-link" title="Chương trình đào tạo theo khối kiến thức">
              <i class="nav-icon fas fa-desktop"></i>
              <p>
