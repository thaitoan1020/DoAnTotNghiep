...
@section('content')
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-3">
            <a href="{{ route('admin.nguoidung_admin') }}" style=" color: black;">
          ...
          <div class="col-md-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Danh tài khoản quản trị</h3>
                ...
                <table id="TableTimKiem" class="table table-head-fixed text-nowrap" style="width: 100%;">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>{{ $value->email }}</td>
                      <td><span class="badge badge-pill badge-danger">Quản trị</span></td>
                      <td>
    ...
    <form action="{{ route('admin.nguoidung_admin.them') }}" method="post">
    @csrf
    <div class="modal fade" id="addModal" tabindex="-1" role="dialog" aria-labelledby="addModalLabel">
      <div class="modal-dialog">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title" id="addModalLabel">Thêm tài khoản quản trị</h5>
  ...
  <form action="{{ route('admin.nguoidung_admin.sua') }}" method="post">
    @csrf
    ...
    <div class="modal fade" id="editModal" tabindex="-1" role="dialog" aria-labelledby="editModalLabel">
      <div class="modal-dialog">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title" id="editModalLabel">Cập nhật tài khoản quản trị</h5>
            <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span>&times;</span></button>
          </div>
          <div class="modal-body">
            <div class="form-group">
  ...
  <form action="{{ route('admin.nguoidung_admin.xoa') }}" method="post">
    @csrf
