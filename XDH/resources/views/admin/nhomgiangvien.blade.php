...
@section('content')
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-3">
                    <a href="{{ route('admin.nhomgiangvien') }}" style=" color: black;">
    ...
    <form action="{{ route('admin.nhomgiangvien.them') }}" method="post">
        @csrf
    ...
    <form action="{{ route('admin.nhomgiangvien.sua') }}" method="post">
        @csrf
    ...
    <form action="{{ route('admin.nhomgiangvien.suagv') }}" method="post">
        @csrf
    ...
    <form action="{{ route('admin.nhomgiangvien.xoa') }}" method="post">
        @csrf
    ...
    <form action="{{ route('admin.nhomgiangvien.xoagv') }}" method="post">
        @csrf
