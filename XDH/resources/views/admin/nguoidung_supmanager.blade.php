...
@section('title')
  Tài khoản trưởng nhóm biên soạn
@endsection
...
@section('content')
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-3">
            <a href="{{ route('admin.nguoidung_supmanager') }}" style=" color: black;">
              <h5> TÀI KHOẢN TRƯỞNG NHÓM BIÊN SOẠN </h5>
            </a>
          </div>
          <div class="col-sm-9">
            <div class="row mb-2 " >
          ...
          <div class="col-md-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Danh tài khoản trưởng nhóm biên soạn</h3>
               ...
               <div class="card-body table-responsive p-0" style="height: 100%;">
                <table id="TableTimKiem" class="table table-head-fixed text-nowrap" style="width: 100%;">
                  ...
                  <tbody>
                    ...
                    @php
                      $editLink = "getCapNhat(" . $value->id . ", '" . $value->name . "', '" . $value->username . "', '" . $value->email . "'); return false;";
                    @endphp
                    <tr>
                      ...
                      <td>{{ $value->email }}</td>
                      <td><span class="badge badge-pill badge-danger">Trưởng nhóm biên soạn</span></td>
                      <td>
    ...
    <form action="{{ route('admin.nguoidung_supmanager.them') }}" method="post">
    @csrf
    <div class="modal fade" id="addModal" tabindex="-1" role="dialog" aria-labelledby="addModalLabel">
      <div class="modal-dialog">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title" id="addModalLabel">Thêm tài khoản nhóm biên soạn</h5>
  ...
  <form action="{{ route('admin.nguoidung_supmanager.sua') }}" method="post">
    @csrf
    ...
    <div class="modal fade" id="editModal" tabindex="-1" role="dialog" aria-labelledby="editModalLabel">
      <div class="modal-dialog">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title" id="editModalLabel">Cập nhật tài khoản nhóm biên soạn</h5>
            <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span>&times;</span></button>
          </div>
          <div class="modal-body">
            <div class="form-group">
  ...
  <form action="{{ route('admin.nguoidung_supmanager.xoa') }}" method="post">
    @csrf
...
@section('javascript')
  <script>
    function getCapNhat(id, name, username, email) {
      $('#id_edit').val(id);
      $('#name_edit').val(name);
    ...
    @if($errors->has('email_edit') || $errors->has('name_edit') || $errors->has('username_edit') || $errors->has('password_edit') || $errors->has('password_edit_confirmation'))
