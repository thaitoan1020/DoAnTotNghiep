...
@section('content')
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-3">
                    <a href="{{ route('user.ctdt_hocphan_khoikienthuc') }}" style=" color: black;">
                    ...
                    <div class="row mb-2 ">
                        <div class="col-sm-9">
                            <div class="row mb-2 ">
                                ...
                                <div class="col-sm-3">
                                    <a href="{{ route('user.ctdt_hocphan.xuat_ctdt_khoikienthuc') }}"
...
@section('javascript')
    ...
    <script type="text/javascript">
        $('#khoikienthuc_SHOW').change(function() {
            ...
            $.ajax({
                url: "{{ route('user.ctdt_hocphan_khoikienthuc.ajax') }}",
                dataType: 'json',
                data: {
                    id: valueuu
                },
