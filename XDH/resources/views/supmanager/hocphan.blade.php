...
@section('content')
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-3">
                    <a href="{{ route('supmanager.hocphan') }}" style=" color: black;">
                                ...
                                <div class="col-sm-9">
                                    <a href="#nhap" class="float-left btn btn-light" data-toggle="modal"
                                        data-target="#importModal" title="Nhập"><i class="fa fa-upload"></i> Nhập Excel<span
                                            class="ml-1"></span></a>
                                    <a href="{{ route('supmanager.hocphan.xuat') }}" class="float-left btn btn-light"><i
                                ...
                                <tbody>
                                    @foreach ($hocphan as $value)
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{ route('supmanager.hocphan.chitiet', ['id' => $value->id]) }}"
    ...
    <form action="{{ route('supmanager.hocphan.them') }}" method="post" enctype="multipart/form-data">
        @csrf
    ...
    <form action="{{ route('supmanager.hocphan.sua') }}" method="post" enctype="multipart/form-data">
        @csrf
    ...
    <form action="{{ route('supmanager.hocphan.xoa') }}" method="post">
        @csrf
    ...
    <form action="{{ route('supmanager.hocphan.nhap') }}" method="post" enctype="multipart/form-data">
        @csrf
