...
@section('content')
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-3">
                    <a href="{{ route('supmanager.ctdt_hocphan_hocky') }}" style=" color: black;">
                    ...
                    <div class="row mb-2 ">
                        <div class="col-sm-9">
                            <div class="row mb-2 ">
                                ...
                                <div class="col-sm-3">
                                    <a href="{{ route('supmanager.ctdt_hocphan.xuat_ctdt_hocky') }}"
...
@section('javascript')
    ...
    <script type="text/javascript">
        $('#HocKy_SHOW').change(function() {
            ...
            $.ajax({
                url: "{{ route('supmanager.ctdt_hocphan_hocky.ajax') }}",
                dataType: 'json',
                data: {
                    id: valueuu
                },
