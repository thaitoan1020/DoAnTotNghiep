...
@section('content')
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-3">
                    <a href="{{ route('supmanager.ctdt_hocphan',['id'=>-1]) }}" style=" color: black;">
                ...
                <div class="col-sm-9">
                    <div class="row mb-2 ">
                        <div class="col-sm-9">
                            ...
                            <form action="{{ route('supmanager.ctdt_hocphan.ajax') }}" method="get">
                                @csrf
                                <div class="row mb-2 ">
                                    <div class="col-sm-8">
                            ...
                            <div class="row mb-2 ">
                                ...
                                <div class="col-sm-3">
                                    <button type="button" class=" btn btn-sm btn-primary btn-floated  " data-toggle="modal"
                                        data-target="#addHPModal" title="Thêm học phần"><span
                                            class="fa fa-plus"></span>Thêm học phần</button>
    ...
    <form action="{{ route('supmanager.ctdt_hocphan.themctdt') }}" method="post">
        @csrf
    ...
    <form action="{{ route('supmanager.ctdt_hocphan.themhp') }}" method="post">
        @csrf
    ...
    <form action="{{ route('supmanager.ctdt_hocphan.themnhptc') }}" method="post">
        @csrf
    ...
    <form action="{{ route('supmanager.ctdt_hocphan.xoa') }}" method="post">
        @csrf
    ...
    <form action="{{ route('supmanager.ctdt_hocphan.nhap') }}" method="post" enctype="multipart/form-data">
        @csrf
...
@section('javascript')
    ...
    <script type="text/javascript">
        $('#ctdt_id_SHOW').change(function() {
            ...
            $.ajax({
                url: "{{ route('supmanager.ctdt_hocphan.ajax') }}",
                dataType: 'json',
                data: {
                    id: valueuu
                },
