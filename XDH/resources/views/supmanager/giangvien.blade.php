...
@section('content')
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-3">
            <a href="{{ route('supmanager.giangvien') }}" style=" color: black;">
    ...
    <form action="{{ route('supmanager.giangvien.them') }}" method="post">
    @csrf
  ...
  <form action="{{ route('supmanager.giangvien.sua') }}" method="post">
    @csrf
  ...
  <form action="{{ route('supmanager.giangvien.xoa') }}" method="post">
    @csrf
